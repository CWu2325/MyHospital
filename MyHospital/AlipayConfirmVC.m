...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"" style:UIBarButtonItemStylePlain target:self action:@selector(left)];;
...
-(void)initUI
{
    ...
    sickNameLabel.text = [NSString stringWithFormat:@"就诊人: %@",self.member.name];
